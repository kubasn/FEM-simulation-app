...
var createModule = (() => {
  ...
  return function (createModule) {
    ...
    if (Module["locateFile"]) {
      ...
      wasmBinaryFile = new URL("fem.wasm", import.meta.url).toString();
    }
    ...
    var __Z5solvev = (Module["__Z5solvev"] = function () {
      return (__Z5solvev = Module["__Z5solvev"] = Module["asm"]["A"]).apply(
        null,
        arguments
      );
    });
